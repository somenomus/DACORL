...
def random_torchvision_loader(
    ...
    **kwargs,
    ...
    # Use OpenWebTextDataset for both OpenWebText and Shakespeare
    DatasetClass = (
        OpenWebTextDataset if name in ["OpenWebText", "Shakespeare"] else getattr(datasets, name)
    )
    ...
    # Only get classes for classification datasets (not for OpenWebText)
