...
#SBATCH --output=DACORL-TRAIN-TD3BC-sgdr-%j.out
#SBATCH --error=DACORL-TRAIN-TD3BC-sgdr-%j.err
...
echo "Conda environment activated. Running DACORL TD3+BC Training (SGDR)..."

# Run training with TD3+BC on sgdr teacher data
python main.py \
...
echo "Trained agent saved in: trained_agents/td3bc/sgdr/"
echo "=========================================="
