#!/bin/bash
#SBATCH --job-name=TD3BC-exponential
...
#SBATCH --output=DACORL-TRAIN-TD3BC-exponential-%j.out
#SBATCH --error=DACORL-TRAIN-TD3BC-exponential-%j.err
...
echo "Conda environment activated. Running DACORL TD3+BC Training (Exponential Decay)..."

# Run training with TD3+BC on exponential_decay teacher data
python main.py \
...
echo "Trained agent saved in: trained_agents/td3bc/exponential_decay/"
echo "=========================================="
